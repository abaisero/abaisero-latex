...
\begin{tabular}{ll}
  ...
  %
  \option{(no-)sets} & Disable/enable set commands \\
  %
...
\begin{tabular}{clll}
  ...
  \midrule
  %
  $\aset$ & \verb|\aset| & A set \\
  %
  $\bset$ & \verb|\bset| & B set \\
  %
  $\cset$ & \verb|\cset| & C set \\
  %
  \vdots & \vdots & \vdots \\
  %
  $\xset$ & \verb|\xset| & X set \\
  %
  $\yset$ & \verb|\yset| & Y set \\
  %
  $\zset$ & \verb|\zset| & Z set \\
  %
  \bottomrule
  %
\end{tabular}
