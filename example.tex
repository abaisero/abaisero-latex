...
\begin{tabular}{cll}
  ...
  \midrule
  %
  $\apolicy$ & \command{apolicy} & Policy A function \\
  %
  $\amodel$ & \command{amodel} & Parametric A model \\
  %
  \midrule
  %
...
\begin{tabular}{cll}
  ...
  \midrule
  %
  $\policies$ & \command{policies } & Joint policies \\
  %
  $\hs$ & \command{hs } & Joint histories \\
  %
  $\as$ & \command{as } & Joint actions \\
  %
  \midrule
  %
  $\qpolicies$ & \command{qpolicies} & Joint Q function \\
  %
  $\vpolicies$ & \command{vpolicies} & Joint V function \\
  %
  $\apolicies$ & \command{apolicies} & Joint A function \\
  %
  $\upolicies$ & \command{upolicies} & Joint U function \\
  %
  \bottomrule
  %
\end{tabular}
