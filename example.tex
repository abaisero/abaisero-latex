...
\begin{tabular}{ll}
  ...
  %
  \option{math} & Enable mathematical commands \\
  %
  \option{no-math} & Disable mathematical commands \\
  %
  \option{linalg} & Enable linear algebra commands \\
  %
  \option{no-linalg} & Disable linear algebra commands \\
  %
  \option{optim} & Enable optimization commands \\
  %
  \option{no-optim} & Disable optimization commands \\
  %
  \option{stats} & Enable statistics commands \\
  %
  \option{no-stats} & Disable statistics commands \\
  %
  \option{dists} & Enable distributions commands \\
  %
  \option{no-dists} & Disable distributions commands \\
  %
  \option{ml} & Enable machine learning commands \\
  %
  \option{no-ml} & Disable machine learning commands \\
  %
  \option{rl} & Enable reinforcement learning commands \\
  %
  \option{no-rl} & Disable reinforcement learning commands \\
  %
  \option{marl} & Enable multi-agent reinforcement learning commands \\
  %
  \option{no-marl} & Disable multi-agent reinforcement learning commands \\
  %
  \option{theorem} & Enable theorem commands \\
  %
  \option{no-theorem} & Disable theorem commands \\
  %
  \option{misc} & Enable miscellanea commands \\
  %
  \option{no-misc} & Disable miscellanea commands \\
  %
  \bottomrule
  %
\end{tabular}
